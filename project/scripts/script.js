...
/* -------------------- MENU DATA -------------------- */
const menuItems = [
  { id:1, name:"Erica's Jollof", category:'meat', price:2200, img:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRA6Jjlr6QK1urtfiaHAbCUmnpovknHFtxzLg&s', alt:'Jollof rice with plantain', featured:true },
  { id:2, name:"Vegetarian Egusi", category:'vegetarian', price:2400,
img:'https://simshomekitchen.com/wp-content/uploads/2025/09/Egusi-tripe-cowfootand-meat-in-a-white-bowl.jpg', alt:'Bowl of egusi with greens', featured:true },
    ...
    grid.innerHTML = items.map(item => {
      ...
      return `
        <article class="card" data-id="${item.id}">
          <img data-src="${item.img}" alt="${item.alt}" class="lazy" loading="lazy" width="350" height="400">
          <h4>${item.name}</h4>
